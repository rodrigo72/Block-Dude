module Tarefa4_2021li1g080_Spec where
...
testsT4 =
  test
    ...
    , "Tarefa 4 - Teste Queda da Caixa" ~: Jogo m21r (Jogador (1,2) Este False) ~=? moveJogador (Jogo m22r (Jogador (1,2) Este True)) InterageCaixa 
